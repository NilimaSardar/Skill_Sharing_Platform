...
export default function ChatRoom() {
  ...
  return (
    ...
    {/* HEADER — Fixed */}
    <div className="flex items-center justify-start px-5 py-4 bg-primary text-white flex-shrink-0 sm:text-text sm:bg-gray-200">
    ...
    {/* CHAT BODY */}
    <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-2 bg-gray-50 hide-scrollbar">
      {messages.map((msg) => (
        <div
          key={msg.id}
    ...
    {/* BOTTOM INPUT */}
    <div className="flex-shrink-0 p-3 border-t border-gray-300 bg-white flex items-center gap-3">
      <input
        type="text"
