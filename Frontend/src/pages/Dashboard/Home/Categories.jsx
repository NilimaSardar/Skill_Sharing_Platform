  ...
  return (
    <div className="bg-white pb-20">
      ...
      <div className='mx-[28px] py-4'>
        ...
        {/* Show Components */}
        <div className="mt-4">
          {activeTab === "share" && <Share category={skillName} type="share" searchTerm={searchTerm} />}
          {activeTab === "exchange" && <Exchange category={skillName} type="exchange" searchTerm={searchTerm} />}
        </div>
