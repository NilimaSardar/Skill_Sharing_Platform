      ...
      <div className='px-7 py-4 w-full'>
        ...
        <div className="flex justify-between items-center bg-primary w-full h-32 my-5 rounded-lg">
          <div className="leading-6 pl-3">
            <h3 className="text-white text-sm sm:text-lg">Find Your Perfect Skill Sharing Partner on ProXchange.</h3>
            <p className='hidden text-white text-sm sm:text-lg sm:block'>Share your expertise and gain new abilities.</p>
            <Link
