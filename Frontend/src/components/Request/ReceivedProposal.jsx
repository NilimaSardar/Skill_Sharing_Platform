    ...
    <div className="flex flex-col gap-4">
      {proposals.map((proposal) => {
        ...
        return (
          <div
            key={proposal._id}
            className="flex relative gap-3 items-start w-full px-2 py-2 rounded-lg border border-border"
          >
            {/* Sender Image */}
            <div className="h-30 w-22 flex-shrink-0 rounded-lg overflow-hidden">
              <img
                src={
                  sender.profilePhoto
            ...
            <div className="flex gap-1 flex-col justify-between w-full">
              ...
              <button
                ...
                className="bg-primary text-white text-[13px] font-medium py-2 px-2 rounded-lg w-full mt-1"
              >
                View Proposal
              </button>
            </div>
